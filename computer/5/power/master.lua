...
network_info = "power_info"
network_command = "power_control"
-- End of Config
...
function PowerManager()
  ...
  this.control_states = function()
    ...
    rednet.broadcast(update, network_command)
  end
  ...
  this.update = function() 
    local sender, message, distance, proto = rednet.receive(network_info)
    if message then
